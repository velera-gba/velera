...
pub fn decode_thumb(cpu: &mut CPU, instruction: u16) {
    ...
    temp_reg_wrap!(
        ...
        ((cond_arm::ARM_CONDITION_EQ as u16) << cond_branch_shift) & extra_opcode_mask,
        ((cond_arm::ARM_CONDITION_NE as u16) << cond_branch_shift) & extra_opcode_mask,
        ((cond_arm::ARM_CONDITION_CS as u16) << cond_branch_shift) & extra_opcode_mask,
        ((cond_arm::ARM_CONDITION_CC as u16) << cond_branch_shift) & extra_opcode_mask,
        ((cond_arm::ARM_CONDITION_MI as u16) << cond_branch_shift) & extra_opcode_mask,
        ((cond_arm::ARM_CONDITION_PL as u16) << cond_branch_shift) & extra_opcode_mask,
        ((cond_arm::ARM_CONDITION_VS as u16) << cond_branch_shift) & extra_opcode_mask,
        ((cond_arm::ARM_CONDITION_VC as u16) << cond_branch_shift) & extra_opcode_mask,
        ((cond_arm::ARM_CONDITION_HI as u16) << cond_branch_shift) & extra_opcode_mask,
        ((cond_arm::ARM_CONDITION_LS as u16) << cond_branch_shift) & extra_opcode_mask,
        ((cond_arm::ARM_CONDITION_GE as u16) << cond_branch_shift) & extra_opcode_mask,
        ((cond_arm::ARM_CONDITION_LT as u16) << cond_branch_shift) & extra_opcode_mask,
        ((cond_arm::ARM_CONDITION_GT as u16) << cond_branch_shift) & extra_opcode_mask,
        ((cond_arm::ARM_CONDITION_LE as u16) << cond_branch_shift) & extra_opcode_mask
    );
